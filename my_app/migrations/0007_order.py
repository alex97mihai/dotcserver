# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-02-28 23:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('my_app', '0006_auto_20180206_0139'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_currency_amount', models.IntegerField(blank=True, max_length=30, null=True)),
                ('rate', models.DecimalField(decimal_places=3, max_digits=10)),
                ('target_currency', models.CharField(blank=True, max_length=30)),
                ('target_currency_amount', models.IntegerField(blank=True, max_length=30, null=True)),
